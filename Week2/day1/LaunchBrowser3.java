...
public class LaunchBrowser3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		CB.findElement(By.linkText("Duplicate Lead")).click();
		CB.findElement(By.id("createLeadForm_companyName")).clear();
		CB.findElement(By.id("createLeadForm_companyName")).sendKeys("ZYX Company");
		CB.findElement(By.id("createLeadForm_firstName")).clear();
		CB.findElement(By.id("createLeadForm_firstName")).sendKeys("Test1");
		CB.findElement(By.name("submitButton")).click();
		String title1 = CB.getTitle();
